...
`STEP 16 READY FOR REVIEW — IMPORT MOBILE DENSITY POLISH`
...
Step 16 is ready for local review and checkpointed locally. Do not push, deploy or apply production Neon migrations without explicit confirmation.
...
After the Step 16 checkpoint, continue the next local UX increment. Do not push, deploy or apply production Neon migrations without explicit confirmation.

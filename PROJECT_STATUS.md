...
- No real local PostgreSQL service is available. Current environment evidence: `DATABASE_URL` is empty, `psql` is unavailable, Docker is unavailable, and no `postgres` process is running.
